...
class Game:
    ...
    def render_board(self):
        # Заголовок: 3 пробела, затем буквы через два пробела, в конце 2 пробела (общая длина 51)
        header = "   " + "  ".join(COLS) + "  "
        lines = [header]
        for i in range(SIZE):
            row_emojis = []
            ...
            # Строка: номер (2 символа) + пробел + эмодзи через пробел + доп. пробел в конце (длина 51)
